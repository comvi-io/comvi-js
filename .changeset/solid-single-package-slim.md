...
Whole-app comvi graph, min+gz, framework peer dependency externalized (`node scripts/size-check.mjs`): the single-package recipe is **6236 B**, identical to the two-package one.
