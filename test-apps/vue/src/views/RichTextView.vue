...
import { ref } from "vue";
import { useI18n, T } from "@comvi/vue";
const { t } = useI18n();

import BoldComponent from "../components/BoldComponent.vue";
  ...
  <div class="space-y-8">
    ...
    <div class="space-y-2">
      ...
      <p class="p-4 bg-gray-50 rounded border">
        <T i18n-key="rich_text.bold_text"></T>
      </p>
    </div>
    ...
    <div class="border-t pt-8 mt-8">
      ...
      <div class="space-y-3 mb-6">
        ...
        <p class="text-sm text-gray-500">
          Switch to German (Sie/Du), French (vous/tu), or Spanish (usted/tú) to see the difference.
