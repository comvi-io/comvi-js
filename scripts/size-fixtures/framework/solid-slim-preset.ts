...
// from `@comvi/solid/slim`; `@comvi/core` is never named.
//
// Measured against `fw-solid-slim`, which builds the identical graph but
...
import { createI18n, I18nProvider, useI18n } from "@comvi/solid/slim";
