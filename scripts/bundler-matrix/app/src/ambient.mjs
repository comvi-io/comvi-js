// The ambient tag channel: `@comvi/core/tags` registers tag syntax as a module
// top-level side effect living in dist/chunks/comvi-core-register-tags(.dev).js
// — the only files in core's `sideEffects` array. If a bundler mis-matches that
// array and strips the registration chunk, string-API t() renders the tags
// literally and this fixture fails.
