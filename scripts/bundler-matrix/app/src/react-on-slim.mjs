// framework-slim gate (plan P0.5, ACTIVATED in P2): a react app on a BARE
// SLIM host.
//
...
assert(typeof useI18nLoader === "function", "@comvi/react exports useI18nLoader");
assert(typeof useI18nPlugins === "function", "@comvi/react exports useI18nPlugins");
